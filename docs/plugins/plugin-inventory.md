...
- **[lightrag](/plugins/reference/lightrag)** (`@openclaw/lightrag-plugin`) - included in OpenClaw. Registers LightRAG servers as ClawWorks enterprise knowledge foundations for knowledge_search.
