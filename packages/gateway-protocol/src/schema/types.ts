...
export type EnterpriseRunRoute = SchemaType<"EnterpriseRunRoute">;
export type EnterpriseModeGetParams = SchemaType<"EnterpriseModeGetParams">;
export type EnterpriseModeGetResult = SchemaType<"EnterpriseModeGetResult">;
export type EnterpriseModeSetParams = SchemaType<"EnterpriseModeSetParams">;
export type EnterpriseModeSetResult = SchemaType<"EnterpriseModeSetResult">;
...
export type EnterpriseOntologyObject = SchemaType<"EnterpriseOntologyObject">;
export type EnterpriseObjectsListParams = SchemaType<"EnterpriseObjectsListParams">;
export type EnterpriseObjectsListResult = SchemaType<"EnterpriseObjectsListResult">;
