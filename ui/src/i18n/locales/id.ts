...
export const id: TranslationMap = {
  ...
  knowledge: {
    title: "Fondasi pengetahuan",
    subtitle: "Sumber retrieval yang dapat dikueri oleh tool knowledge_search.",
    empty: "Tidak ada fondasi pengetahuan yang terdaftar.",
    emptyHint: "Aktifkan plugin adapter (misalnya LightRAG) untuk mendaftarkan satu.",
    kindLocal: "lokal",
    kindRemote: "remote",
    kindLocalTitle: "Deployment ini mengelola dokumen server ini.",
    kindRemoteTitle: "Dioperasikan di tempat lain; hanya-baca dari sini.",
    testConnection: "Tes koneksi",
    testing: "Menguji…",
    statusOk: "Dapat dijangkau",
    statusFailed: "Tidak dapat dijangkau",
    statusUnsupported: "Tidak dapat diperiksa",
    statusNotRegistered: "Tidak lagi terdaftar",
    statusUnsupportedTitle: "Adapter ini tidak mengimplementasikan pemeriksaan koneksi.",
    statusNotRegisteredTitle: "Plugin yang mendaftarkannya tidak lagi aktif. Segarkan daftar.",
    referencedBy: "Direferensikan oleh {count} langkah",
    referencedByNone: "Tidak direferensikan oleh langkah workflow mana pun.",
    referencedByHint:
      "Langkah-langkah yang daftar izin ontologinya mencantumkan fondasi ini. Edit daftar izin di tab Enterprise.",
    files: "File",
    filesShow: "Tampilkan file",
    filesHide: "Sembunyikan file",
    filesEmpty: "Belum ada dokumen yang diunggah.",
    filesReadOnly:
      "Fondasi ini dioperasikan di tempat lain, sehingga dokumennya hanya-baca di sini.",
    filesUnsupported: "Adapter ini tidak menyediakan manajemen dokumen.",
    filesNotRegistered: "Fondasi ini tidak lagi terdaftar. Segarkan daftar.",
    filesFailed: "Tidak dapat memuat dokumen.",
    upload: "Unggah dokumen",
    uploading: "Mengunggah…",
    uploadAccepted: "{name} diunggah. Pengindeksan berjalan di latar belakang.",
    uploadDuplicate:
      "Dokumen bernama {name} sudah ada. Hapus terlebih dahulu sebelum mengunggah ulang.",
    uploadTooLarge: "File tersebut lebih besar dari batas unggahan {limit}.",
    uploadFailed: "Pengunggahan gagal: {detail}",
    remove: "Hapus",
    removeTitle: "Hapus {name}?",
    removeBody:
      "Ini akan menghapus dokumen dan semua yang diindeks darinya. Agen tidak akan lagi mengambilnya. Tindakan ini tidak dapat dibatalkan.",
    removeStarted: "Penghapusan {name} dimulai. Proses berjalan di latar belakang.",
    removeBusy: "Penyimpanan sedang sibuk mengindeks. Coba hapus lagi sebentar.",
    removeFailed: "Penghapusan gagal: {detail}",
    docStatusPending: "Tertunda",
    docStatusProcessing: "Mengindeks",
    docStatusIndexed: "Terindeks",
    docStatusFailed: "Gagal",
    docStatusUnknown: "Tidak diketahui",
    docChunks: "{count} bagian",
    docSummary: "Ringkasan",
    docNoSummary: "Penyimpanan ini tidak menampilkan pratinjau untuk dokumen ini.",
  },
  enterprise: {
    title: "Enterprise",
    ...
    noTrees: "Tidak ada pohon alur kerja yang terdaftar.",
    selectRun: "Pilih eksekusi untuk memeriksa langkah-langkah dan jejak tata kelolanya.",
    detailUnavailable: "Detail eksekusi tidak lagi tersedia.",
    detailTitle: "Detail eksekusi",
    activeStep: "Langkah aktif: {node}",
    executionCount: "{count} eksekusi dari run ini",
    stepsTitle: "Langkah-langkah",
    traceTitle: "Jejak tata kelola",
    noTrace: "Tidak ada peristiwa tata kelola yang tercatat untuk eksekusi ini.",
    allowedTools: "Izinkan: {tools}",
    ...
    importErrors:
      "Beberapa tree yang diimpor gagal dimuat; eksekusi enforce-mode pada tree tersebut diblokir.",
    storeError: "Penyimpanan workflow tree tidak dapat dibaca: {message}",
    ...
    nodeInspectorTitle: "Ontologi node",
    nodeNoOntology: "Cakupan langkah ini tidak mendeklarasikan tipe ontologi.",
    nodeObjectsTitle: "Objek",
    nodeNoObjects: "Belum ada objek dengan tipe ini.",
    addNodeButton: "Tambah node anak",
    addNodeTitle: "Node anak baru",
    addNodeIdLabel: "Id node (huruf kecil bertitik, mis. support.triage)",
    addNodeTitleLabel: "Judul",
    addNodeSubmit: "Tambahkan ke editor",
    addNodeErrorIdEmpty: "Masukkan id node.",
    addNodeErrorIdPattern: "Id harus huruf kecil bertitik, mis. support.triage.",
    addNodeErrorIdDuplicate: "Node dengan id tersebut sudah ada di pohon ini.",
    addNodeErrorTitleEmpty: "Masukkan judul.",
    addNodeErrorParentMissing: "Node induk tidak lagi ada di pohon ini.",
    addNodeErrorExportFailed: "Tidak dapat memuat definisi pohon untuk diedit.",
    ...
    mode: {
      label: "Enterprise",
      hint: "Mode workflow terkendali untuk asisten ini",
      enforce: {
        label: "Enforce",
        hint: "Governance memblokir tools di luar cakupan",
      },
      observe: {
        label: "Observe",
        hint: "Mencatat keputusan, tidak memblokir apa pun",
      },
      off: {
        label: "Nonaktif",
        hint: "Tanpa mediasi alur kerja",
      },
    },
    routeCoverage: "{coverage} node direncanakan",
    routeInvalid: "Planner menamai rute yang tidak ada di tree ini: {routes}",
    routeSource: {
      planner: "planner",
      wholeTree: "whole tree",
    },
    resetView: "Atur ulang tampilan",
    noRelationships: "Tidak ada relasi yang dideklarasikan.",
    selectStep: "Pilih langkah untuk memeriksa cakupan ontologinya.",
    noStepScope: "Langkah ini tidak mendeklarasikan cakupan ontologi.",
    actions: "Tindakan: {ids}",
    contextHints: "Petunjuk konteks: {hints}",
    expectedOutput: "Output yang diharapkan: {text}",
    newTree: "Tree baru",
    edit: "Edit",
    exportYaml: "Ekspor YAML",
    exportJson: "Ekspor JSON",
    remove: "Hapus",
    editorTitle: "Edit definisi tree",
    editorHint: "Edit definisi mentah, lalu Simpan untuk merekam versi baru.",
    saveInvalid: "Definisi tidak lolos validasi:",
    saving: "Menyimpan…",
    save: "Simpan",
    historyTitle: "Riwayat versi",
    noHistory: "Belum ada revisi yang disimpan.",
    revision: "Revisi {revision}",
    confirmSaveTitle: "Simpan workflow tree?",
    confirmSaveBody: "Ini mengimpor definisi yang diedit dan mencatat revisi baru.",
    confirmRemoveTitle: "Hapus workflow tree?",
    confirmRemoveBody: "Hapus tree {treeId} yang diimpor dari registri.",
    confirmRemoveWarning:
      "Definisi aktif akan dihapus; definisi bawaan yang tersembunyi akan muncul kembali. Riwayat versi tetap disimpan.",
  },
  sessionsView: {
    title: "Sesi",
