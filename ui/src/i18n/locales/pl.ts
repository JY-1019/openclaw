...
export const pl: TranslationMap = {
  ...
  knowledge: {
    title: "Bazy wiedzy",
    subtitle: "Źródła wyszukiwania, które może odpytywać narzędzie knowledge_search.",
    empty: "Nie zarejestrowano żadnych baz wiedzy.",
    emptyHint: "Włącz wtyczkę adaptera (na przykład LightRAG), aby zarejestrować bazę.",
    kindLocal: "lokalna",
    kindRemote: "zdalna",
    kindLocalTitle: "To wdrożenie zarządza dokumentami tego serwera.",
    kindRemoteTitle: "Obsługiwana gdzie indziej; tutaj tylko do odczytu.",
    testConnection: "Testuj połączenie",
    testing: "Testowanie…",
    statusOk: "Dostępna",
    statusFailed: "Niedostępna",
    statusUnsupported: "Nie można sprawdzić",
    statusNotRegistered: "Już niezarejestrowana",
    statusUnsupportedTitle: "Ten adapter nie obsługuje sprawdzania połączenia.",
    statusNotRegisteredTitle:
      "Wtyczka, która ją zarejestrowała, nie jest już aktywna. Odśwież listę.",
    referencedBy: "Przywoływana przez {count} krok(ów)",
    referencedByNone: "Nie jest przywoływana przez żaden krok przepływu pracy.",
    referencedByHint:
      "Kroki, których lista dozwolonych ontologii zawiera nazwę tej bazy. Edytuj listę dozwolonych na karcie Enterprise.",
    files: "Pliki",
    filesShow: "Pokaż pliki",
    filesHide: "Ukryj pliki",
    filesEmpty: "Nie przesłano jeszcze żadnych dokumentów.",
    filesReadOnly:
      "Ta baza jest zarządzana gdzie indziej, więc jej dokumenty są tutaj tylko do odczytu.",
    filesUnsupported: "Ten adapter nie udostępnia zarządzania dokumentami.",
    filesNotRegistered: "Ta baza nie jest już zarejestrowana. Odśwież listę.",
    filesFailed: "Nie udało się załadować dokumentów.",
    upload: "Prześlij dokument",
    uploading: "Przesyłanie…",
    uploadAccepted: "Przesłano {name}. Indeksowanie odbywa się w tle.",
    uploadDuplicate: "Dokument o nazwie {name} już istnieje. Usuń go przed ponownym przesłaniem.",
    uploadTooLarge: "Ten plik przekracza limit przesyłania wynoszący {limit}.",
    uploadFailed: "Przesyłanie nie powiodło się: {detail}",
    remove: "Usuń",
    removeTitle: "Usunąć {name}?",
    removeBody:
      "Spowoduje to usunięcie dokumentu i wszystkich zaindeksowanych z niego danych. Agenci nie będą już mogli go pobierać. Tej operacji nie można cofnąć.",
    removeStarted: "Rozpoczęto usuwanie {name}. Proces odbywa się w tle.",
    removeBusy: "Magazyn jest zajęty indeksowaniem. Spróbuj usunąć ponownie za chwilę.",
    removeFailed: "Usuwanie nie powiodło się: {detail}",
    docStatusPending: "Oczekuje",
    docStatusProcessing: "Indeksowanie",
    docStatusIndexed: "Zaindeksowano",
    docStatusFailed: "Niepowodzenie",
    docStatusUnknown: "Nieznany",
    docChunks: "{count} fragment(ów)",
    docSummary: "Podsumowanie",
    docNoSummary: "Ten magazyn nie udostępnia podglądu tego dokumentu.",
  },
  enterprise: {
    title: "Enterprise",
    ...
    noTrees: "Brak zarejestrowanych drzew workflow.",
    selectRun: "Wybierz uruchomienie, aby sprawdzić jego kroki i ślad zarządzania.",
    detailUnavailable: "Szczegóły uruchomienia nie są już dostępne.",
    detailTitle: "Szczegóły uruchomienia",
    activeStep: "Aktywny krok: {node}",
    executionCount: "Liczba wykonań tego uruchomienia: {count}",
    stepsTitle: "Kroki",
    traceTitle: "Ślad zarządzania",
    noTrace: "Brak zarejestrowanych zdarzeń zarządzania dla tego wykonania.",
    allowedTools: "Dozwolone: {tools}",
    deniedTools: "Zabronione: {tools}",
    knowledge: "Wiedza: {ids}",
    guidance: "Instrukcje: {text}",
    audit: "Zaudytowane",
    activeBadge: "aktywne",
    nodeCount: "Liczba kroków: {count}",
    importErrors:
      "Niektóre zaimportowane drzewa nie zostały załadowane; uruchomienia w trybie enforce są dla nich zablokowane.",
    storeError: "Magazyn drzew workflow jest nieczytelny: {message}",
    selectTree: "Wybierz drzewo workflow, aby zwizualizować jego strukturę i ontologię.",
    treeTitle: "Wizualizacja drzewa",
    ...
    nodeInspectorTitle: "Ontologia węzła",
    nodeNoOntology: "Zakres tego kroku nie deklaruje żadnych typów ontologii.",
    nodeObjectsTitle: "Obiekty",
    nodeNoObjects: "Nie istnieją jeszcze żadne obiekty tego typu.",
    addNodeButton: "Dodaj węzeł podrzędny",
    addNodeTitle: "Nowy węzeł podrzędny",
    addNodeIdLabel: "Id węzła (małe litery z kropkami, np. support.triage)",
    addNodeTitleLabel: "Tytuł",
    addNodeSubmit: "Dodaj do edytora",
    addNodeErrorIdEmpty: "Wprowadź id węzła.",
    addNodeErrorIdPattern:
      "Id musi składać się z małych liter oddzielonych kropkami, np. support.triage.",
    addNodeErrorIdDuplicate: "Węzeł o tym id już istnieje w tym drzewie.",
    addNodeErrorTitleEmpty: "Wprowadź tytuł.",
    addNodeErrorParentMissing: "Węzeł nadrzędny nie znajduje się już w tym drzewie.",
    addNodeErrorExportFailed: "Nie udało się wczytać definicji drzewa do edycji.",
    ...
    mode: {
      label: "Enterprise",
      hint: "Zarządzany tryb workflow dla tego asystenta",
      enforce: {
        label: "Enforce",
        hint: "Governance blokuje narzędzia poza zakresem",
      },
      observe: {
        label: "Observe",
        hint: "Rejestruje decyzje, niczego nie blokuje",
      },
      off: {
        label: "Wyłączone",
        hint: "Brak mediacji przepływu pracy",
      },
    },
    routeCoverage: "Zaplanowano {coverage} węzłów",
    routeInvalid: "Planer wskazał trasy, które nie istnieją w tym drzewie: {routes}",
    routeSource: {
      planner: "planer",
      wholeTree: "całe drzewo",
    },
    resetView: "Resetuj widok",
    noRelationships: "Brak zadeklarowanych relacji.",
    selectStep: "Wybierz krok, aby sprawdzić jego zakres ontologii.",
    noStepScope: "Ten krok nie deklaruje zakresu ontologii.",
    actions: "Akcje: {ids}",
    contextHints: "Wskazówki kontekstowe: {hints}",
    expectedOutput: "Oczekiwane wyjście: {text}",
    newTree: "Nowe drzewo",
    edit: "Edytuj",
    exportYaml: "Eksportuj YAML",
    exportJson: "Eksportuj JSON",
    remove: "Usuń",
    editorTitle: "Edytuj definicję drzewa",
    editorHint: "Edytuj surową definicję, a następnie zapisz, aby utworzyć nową wersję.",
    saveInvalid: "Definicja nie przeszła walidacji:",
    saving: "Zapisywanie…",
    save: "Zapisz",
    historyTitle: "Historia wersji",
    noHistory: "Brak zapisanych wersji.",
    revision: "Wersja {revision}",
    confirmSaveTitle: "Zapisać drzewo workflow?",
    confirmSaveBody: "Spowoduje to zaimportowanie edytowanej definicji i zapisanie nowej wersji.",
    confirmRemoveTitle: "Usunąć drzewo workflow?",
    confirmRemoveBody: "Usuń zaimportowane drzewo {treeId} z rejestru.",
    confirmRemoveWarning:
      "Aktywna definicja zostanie usunięta; przesłonięta wbudowana definicja pojawi się ponownie. Historia wersji zostanie zachowana.",
  },
  sessionsView: {
    title: "Sesje",
