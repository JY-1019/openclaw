...
export const it: TranslationMap = {
  ...
  knowledge: {
    ...
    subtitle: "Fonti di recupero interrogabili dallo strumento knowledge_search.",
    empty: "Nessuna base di conoscenza registrata.",
    emptyHint: "Abilita un plugin adattatore (ad esempio LightRAG) per registrarne una.",
    kindLocal: "locale",
    kindRemote: "remoto",
    kindLocalTitle: "Questo deployment gestisce i documenti di questo server.",
    kindRemoteTitle: "Gestito altrove; sola lettura da qui.",
    testConnection: "Testa connessione",
    testing: "Test in corso…",
    statusOk: "Raggiungibile",
    statusFailed: "Non raggiungibile",
    statusUnsupported: "Non verificabile",
    statusNotRegistered: "Non più registrato",
    statusUnsupportedTitle: "Questo adattatore non implementa un controllo della connessione.",
    statusNotRegisteredTitle: "Il plugin che lo ha registrato non è più attivo. Aggiorna l'elenco.",
    referencedBy: "Referenziato da {count} passaggio/i",
    referencedByNone: "Non referenziato da alcun passaggio del workflow.",
    referencedByHint:
      "Passaggi la cui lista consentita dell'ontologia include questa base. Modifica la lista consentita nella scheda Enterprise.",
    files: "File",
    filesShow: "Mostra file",
    filesHide: "Nascondi file",
    filesEmpty: "Non è stato ancora caricato alcun documento.",
    filesReadOnly:
      "Questa fondazione è gestita altrove, quindi i suoi documenti sono in sola lettura qui.",
    filesUnsupported: "Questo adapter non espone la gestione dei documenti.",
    filesNotRegistered: "Questa fondazione non è più registrata. Aggiorna l'elenco.",
    filesFailed: "Impossibile caricare i documenti.",
    upload: "Carica documento",
    uploading: "Caricamento…",
    uploadAccepted: "{name} caricato. L'indicizzazione viene eseguita in background.",
    uploadDuplicate:
      "Esiste già un documento denominato {name}. Rimuovilo prima di caricarlo di nuovo.",
    uploadTooLarge: "Il file supera il limite di caricamento di {limit}.",
    uploadFailed: "Caricamento non riuscito: {detail}",
    remove: "Rimuovi",
    removeTitle: "Rimuovere {name}?",
    removeBody:
      "Questo elimina il documento e tutto ciò che è stato indicizzato da esso. Gli agenti non potranno più recuperarlo. Questa operazione non può essere annullata.",
    removeStarted: "Rimozione di {name} avviata. Viene eseguita in background.",
    removeBusy: "Lo store è occupato con l'indicizzazione. Riprova a breve.",
    removeFailed: "Rimozione non riuscita: {detail}",
    docStatusPending: "In attesa",
    docStatusProcessing: "Indicizzazione",
    docStatusIndexed: "Indicizzato",
    docStatusFailed: "Non riuscito",
    docStatusUnknown: "Sconosciuto",
    docChunks: "{count} frammento/i",
    docSummary: "Riepilogo",
    docNoSummary: "Questo archivio non espone alcuna anteprima per questo documento.",
  },
  enterprise: {
    title: "Enterprise",
    ...
    noTrees: "Nessun albero di workflow registrato.",
    selectRun: "Seleziona un'esecuzione per ispezionarne i passaggi e la traccia di governance.",
    detailUnavailable: "Il dettaglio dell'esecuzione non è più disponibile.",
    detailTitle: "Dettaglio esecuzione",
    activeStep: "Passaggio attivo: {node}",
    executionCount: "{count} esecuzione/i di questo run",
    stepsTitle: "Passaggi",
    traceTitle: "Traccia di governance",
    noTrace: "Nessun evento di governance registrato per questa esecuzione.",
    allowedTools: "Consenti: {tools}",
    deniedTools: "Nega: {tools}",
    ...
    importErrors:
      "Alcuni alberi importati non sono stati caricati; le esecuzioni in modalità enforce sono bloccate.",
    storeError: "Archivio alberi di workflow illeggibile: {message}",
    ...
    action: "Azione: {id}",
    constraint: "Vincolo: {text}",
    noOntology: "Questo albero non dichiara entità o relazioni ontologiche.",
    nodeInspectorTitle: "Ontologia del nodo",
    nodeNoOntology: "L'ambito di questo passaggio non dichiara tipi di ontologia.",
    nodeObjectsTitle: "Oggetti",
    nodeNoObjects: "Non esistono ancora oggetti di questo tipo.",
    addNodeButton: "Aggiungi nodo figlio",
    addNodeTitle: "Nuovo nodo figlio",
    addNodeIdLabel: "Id nodo (minuscolo con punti, es. support.triage)",
    addNodeTitleLabel: "Titolo",
    addNodeSubmit: "Aggiungi all'editor",
    addNodeErrorIdEmpty: "Inserisci un id nodo.",
    addNodeErrorIdPattern: "L'id deve essere minuscolo con punti, es. support.triage.",
    addNodeErrorIdDuplicate: "Un nodo con questo id esiste già in questo albero.",
    addNodeErrorTitleEmpty: "Inserisci un titolo.",
    addNodeErrorParentMissing: "Il nodo padre non è più presente in questo albero.",
    addNodeErrorExportFailed: "Impossibile caricare la definizione dell'albero da modificare.",
    ...
    routeExpand: "Espandi",
    routeExpandTitle: "Percorso del workflow",
    routeExpandClose: "Chiudi",
    propertyPrimaryKey: "PK",
    propertyRequired: "obbligatorio",
    mode: {
      label: "Enterprise",
      hint: "Modalità workflow governato per questo assistente",
      enforce: {
        label: "Enforce",
        hint: "La governance blocca gli strumenti fuori ambito",
      },
      observe: {
        label: "Observe",
        hint: "Registra le decisioni, non blocca nulla",
      },
      off: {
        label: "Disattivato",
        hint: "Nessuna mediazione del workflow",
      },
    },
    routeCoverage: "{coverage} nodi pianificati",
    routeInvalid: "Il planner ha indicato route che non esistono in questo albero: {routes}",
    routeSource: {
      planner: "planner",
      wholeTree: "albero intero",
    },
    resetView: "Reimposta vista",
    noRelationships: "Nessuna relazione dichiarata.",
    selectStep: "Seleziona uno step per ispezionarne l'ambito ontologico.",
    noStepScope: "Questo step non dichiara alcun ambito ontologico.",
    actions: "Azioni: {ids}",
    contextHints: "Suggerimenti di contesto: {hints}",
    expectedOutput: "Output previsto: {text}",
    newTree: "Nuovo albero",
    edit: "Modifica",
    exportYaml: "Esporta YAML",
    exportJson: "Esporta JSON",
    remove: "Rimuovi",
    editorTitle: "Modifica definizione albero",
    editorHint: "Modifica la definizione grezza, quindi salva per registrare una nuova versione.",
    saveInvalid: "La definizione non ha superato la validazione:",
    saving: "Salvataggio…",
    save: "Salva",
    historyTitle: "Cronologia versioni",
    noHistory: "Nessuna revisione salvata.",
    revision: "Revisione {revision}",
    confirmSaveTitle: "Salvare l'albero del workflow?",
    confirmSaveBody:
      "Questa operazione importa la definizione modificata e registra una nuova revisione.",
    confirmRemoveTitle: "Rimuovere l'albero del workflow?",
    confirmRemoveBody: "Rimuovi l'albero importato {treeId} dal registro.",
    confirmRemoveWarning:
      "La definizione attiva viene eliminata; un elemento integrato nascosto riappare. La cronologia versioni viene conservata.",
  },
  sessionsView: {
    title: "Sessioni",
