...
export const th: TranslationMap = {
  ...
  knowledge: {
    title: "ฐานความรู้",
    subtitle: "แหล่งข้อมูลสืบค้นที่เครื่องมือ knowledge_search สามารถค้นหาได้",
    empty: "ไม่มีฐานความรู้ที่ลงทะเบียนไว้",
    emptyHint: "เปิดใช้งานปลั๊กอินอะแดปเตอร์ (เช่น LightRAG) เพื่อลงทะเบียน",
    kindLocal: "ภายในเครื่อง",
    kindRemote: "ระยะไกล",
    kindLocalTitle: "การติดตั้งนี้จัดการเอกสารของเซิร์ฟเวอร์นี้",
    kindRemoteTitle: "ดำเนินการจากที่อื่น อ่านอย่างเดียวจากที่นี่",
    testConnection: "ทดสอบการเชื่อมต่อ",
    testing: "กำลังทดสอบ…",
    statusOk: "เข้าถึงได้",
    statusFailed: "เข้าถึงไม่ได้",
    statusUnsupported: "ไม่สามารถตรวจสอบได้",
    statusNotRegistered: "ไม่ได้ลงทะเบียนแล้ว",
    statusUnsupportedTitle: "อะแดปเตอร์นี้ไม่รองรับการตรวจสอบการเชื่อมต่อ",
    statusNotRegisteredTitle: "ปลั๊กอินที่ลงทะเบียนไว้ไม่ได้ใช้งานอยู่แล้ว กรุณารีเฟรชรายการ",
    referencedBy: "ถูกอ้างอิงโดย {count} ขั้นตอน",
    referencedByNone: "ไม่ได้ถูกอ้างอิงโดยขั้นตอนเวิร์กโฟลว์ใด ๆ",
    referencedByHint: "ขั้นตอนที่รายการอนุญาต ontology ระบุชื่อฐานความรู้นี้ แก้ไขรายการอนุญาตได้ในแท็บ Enterprise",
    files: "ไฟล์",
    filesShow: "แสดงไฟล์",
    filesHide: "ซ่อนไฟล์",
    filesEmpty: "ยังไม่มีเอกสารที่อัปโหลด",
    filesReadOnly: "ฐานข้อมูลนี้ดำเนินการจากที่อื่น เอกสารจึงเป็นแบบอ่านอย่างเดียวที่นี่",
    filesUnsupported: "อะแดปเตอร์นี้ไม่รองรับการจัดการเอกสาร",
    filesNotRegistered: "ฐานข้อมูลนี้ไม่ได้ลงทะเบียนแล้ว กรุณารีเฟรชรายการ",
    filesFailed: "ไม่สามารถโหลดเอกสารได้",
    upload: "อัปโหลดเอกสาร",
    uploading: "กำลังอัปโหลด…",
    uploadAccepted: "อัปโหลด {name} แล้ว การจัดทำดัชนีทำงานในเบื้องหลัง",
    uploadDuplicate: "มีเอกสารชื่อ {name} อยู่แล้ว กรุณาลบออกก่อนอัปโหลดใหม่",
    uploadTooLarge: "ไฟล์มีขนาดเกินขีดจำกัดการอัปโหลด {limit}",
    uploadFailed: "อัปโหลดล้มเหลว: {detail}",
    remove: "ลบ",
    removeTitle: "ลบ {name} หรือไม่?",
    removeBody:
      "การดำเนินการนี้จะลบเอกสารและทุกสิ่งที่จัดทำดัชนีจากเอกสารนั้น เอเจนต์จะไม่สามารถเรียกค้นได้อีกต่อไป การดำเนินการนี้ไม่สามารถย้อนกลับได้",
    removeStarted: "เริ่มลบ {name} แล้ว การดำเนินการทำงานในเบื้องหลัง",
    removeBusy: "ที่เก็บข้อมูลกำลังจัดทำดัชนีอยู่ กรุณาลองลบอีกครั้งในอีกสักครู่",
    removeFailed: "การลบล้มเหลว: {detail}",
    docStatusPending: "รอดำเนินการ",
    docStatusProcessing: "กำลังจัดทำดัชนี",
    docStatusIndexed: "จัดทำดัชนีแล้ว",
    docStatusFailed: "ล้มเหลว",
    docStatusUnknown: "ไม่ทราบ",
    docChunks: "{count} ส่วน",
    docSummary: "สรุป",
    docNoSummary: "ที่เก็บนี้ไม่มีตัวอย่างสำหรับเอกสารนี้",
  },
  enterprise: {
    title: "Enterprise",
    ...
    noTrees: "ยังไม่มีแผนผังเวิร์กโฟลว์ที่ลงทะเบียน",
    selectRun: "เลือกการรันเพื่อตรวจสอบขั้นตอนและร่องรอยการกำกับดูแล",
    detailUnavailable: "รายละเอียดการรันไม่พร้อมใช้งานแล้ว",
    detailTitle: "รายละเอียดการรัน",
    activeStep: "ขั้นตอนที่ใช้งานอยู่: {node}",
    executionCount: "{count} การดำเนินการของการรันนี้",
    stepsTitle: "ขั้นตอน",
    traceTitle: "ร่องรอยการกำกับดูแล",
    noTrace: "ไม่มีเหตุการณ์การกำกับดูแลที่บันทึกไว้สำหรับการดำเนินการนี้",
    ...
    importErrors: "ต้นไม้ที่นำเข้าบางรายการโหลดไม่สำเร็จ การรันในโหมด enforce ถูกบล็อก",
    storeError: "ไม่สามารถอ่านที่เก็บต้นไม้เวิร์กโฟลว์ได้: {message}",
    selectTree: "เลือกต้นไม้เวิร์กโฟลว์เพื่อแสดงโครงสร้างและออนโทโลยี",
    treeTitle: "การแสดงผลต้นไม้",
    ...
    nodeInspectorTitle: "ออนโทโลยีของโหนด",
    nodeNoOntology: "ขอบเขตของขั้นตอนนี้ไม่มีการประกาศประเภทออนโทโลยี",
    nodeObjectsTitle: "ออบเจกต์",
    nodeNoObjects: "ยังไม่มีออบเจกต์ประเภทนี้",
    addNodeButton: "เพิ่มโหนดย่อย",
    addNodeTitle: "โหนดลูกใหม่",
    addNodeIdLabel: "รหัสโหนด (ตัวพิมพ์เล็กคั่นด้วยจุด เช่น support.triage)",
    addNodeTitleLabel: "ชื่อ",
    addNodeSubmit: "เพิ่มไปยังตัวแก้ไข",
    addNodeErrorIdEmpty: "กรุณาป้อนรหัสโหนด",
    addNodeErrorIdPattern: "รหัสต้องเป็นตัวพิมพ์เล็กคั่นด้วยจุด เช่น support.triage",
    addNodeErrorIdDuplicate: "โหนดที่มีรหัสนี้มีอยู่แล้วในแผนผังนี้",
    addNodeErrorTitleEmpty: "กรุณาป้อนชื่อ",
    addNodeErrorParentMissing: "โหนดแม่ไม่อยู่ในแผนผังนี้แล้ว",
    addNodeErrorExportFailed: "ไม่สามารถโหลดคำจำกัดความของแผนผังเพื่อแก้ไขได้",
    ...
    mode: {
      label: "Enterprise",
      hint: "โหมดเวิร์กโฟลว์ที่มีการกำกับดูแลสำหรับผู้ช่วยนี้",
      enforce: {
        label: "บังคับใช้",
        hint: "การกำกับดูแลบล็อกเครื่องมือที่อยู่นอกขอบเขต",
      },
      observe: {
        label: "สังเกตการณ์",
        hint: "บันทึกการตัดสินใจ ไม่บล็อกสิ่งใด",
      },
      off: {
        label: "ปิด",
        hint: "ไม่มีการจัดการเวิร์กโฟลว์",
      },
    },
    routeCoverage: "วางแผนไว้ {coverage} โหนด",
    routeInvalid: "ตัววางแผนระบุเส้นทางที่ไม่มีอยู่ในทรีนี้: {routes}",
    routeSource: {
      planner: "ตัววางแผน",
      wholeTree: "ทั้งทรี",
    },
    resetView: "รีเซ็ตมุมมอง",
    noRelationships: "ไม่มีความสัมพันธ์ที่ประกาศไว้",
    selectStep: "เลือกขั้นตอนเพื่อตรวจสอบขอบเขตออนโทโลยี",
    noStepScope: "ขั้นตอนนี้ไม่ได้ประกาศขอบเขตออนโทโลยี",
    actions: "การดำเนินการ: {ids}",
    contextHints: "คำแนะนำบริบท: {hints}",
    expectedOutput: "ผลลัพธ์ที่คาดหวัง: {text}",
    newTree: "ทรีใหม่",
    edit: "แก้ไข",
    exportYaml: "ส่งออก YAML",
    exportJson: "ส่งออก JSON",
    remove: "ลบ",
    editorTitle: "แก้ไขคำจำกัดความของทรี",
    editorHint: "แก้ไขคำจำกัดความดิบ จากนั้นกดบันทึกเพื่อบันทึกเวอร์ชันใหม่",
    saveInvalid: "คำจำกัดความไม่ผ่านการตรวจสอบ:",
    saving: "กำลังบันทึก…",
    save: "บันทึก",
    historyTitle: "ประวัติเวอร์ชัน",
    noHistory: "ยังไม่มีรีวิชันที่บันทึกไว้",
    revision: "รีวิชัน {revision}",
    confirmSaveTitle: "บันทึก workflow tree หรือไม่?",
    confirmSaveBody: "การดำเนินการนี้จะนำเข้าคำจำกัดความที่แก้ไขและบันทึกรีวิชันใหม่",
    confirmRemoveTitle: "ลบ workflow tree หรือไม่?",
    confirmRemoveBody: "ลบ tree {treeId} ที่นำเข้าออกจากรีจิสทรี",
    confirmRemoveWarning:
      "คำจำกัดความที่ใช้งานอยู่จะถูกลบ และรายการในตัวที่ถูกซ่อนจะปรากฏขึ้นอีกครั้ง ประวัติเวอร์ชันจะยังคงอยู่",
  },
  sessionsView: {
    title: "เซสชัน",
