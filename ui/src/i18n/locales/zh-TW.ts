...
export const zh_TW: TranslationMap = {
  ...
  knowledge: {
    title: "知識基礎",
    subtitle: "knowledge_search 工具可查詢的檢索來源。",
    empty: "尚未註冊任何知識基礎。",
    emptyHint: "啟用轉接器外掛（例如 LightRAG）以註冊一個。",
    kindLocal: "本機",
    kindRemote: "遠端",
    kindLocalTitle: "此部署管理此伺服器的文件。",
    kindRemoteTitle: "由其他位置營運；從此處僅供唯讀。",
    testConnection: "測試連線",
    testing: "測試中…",
    statusOk: "可連線",
    statusFailed: "無法連線",
    statusUnsupported: "無法檢查",
    statusNotRegistered: "已不再註冊",
    statusUnsupportedTitle: "此轉接器未實作連線檢查。",
    statusNotRegisteredTitle: "註冊它的外掛已不再啟用。請重新整理清單。",
    referencedBy: "被 {count} 個步驟參照",
    referencedByNone: "未被任何工作流程步驟參照。",
    referencedByHint:
      "其本體論允許清單中包含此基礎名稱的步驟。請在 Enterprise 分頁中編輯允許清單。",
    files: "檔案",
    filesShow: "顯示檔案",
    filesHide: "隱藏檔案",
    filesEmpty: "尚未上傳任何文件。",
    filesReadOnly: "此基礎由其他位置管理，因此文件在此為唯讀。",
    filesUnsupported: "此適配器不支援文件管理。",
    filesNotRegistered: "此基礎已不再註冊。請重新整理列表。",
    filesFailed: "無法載入文件。",
    upload: "上傳文件",
    uploading: "上傳中…",
    uploadAccepted: "{name} 已上傳。索引正在背景執行。",
    uploadDuplicate: "已存在名為 {name} 的文件。請先移除再重新上傳。",
    uploadTooLarge: "該檔案超過 {limit} 的上傳限制。",
    uploadFailed: "上傳失敗：{detail}",
    remove: "移除",
    removeTitle: "要移除 {name} 嗎？",
    removeBody: "這將刪除該文件及其所有索引內容。代理將無法再檢索該文件。此操作無法復原。",
    removeStarted: "已開始移除 {name}。正在背景執行。",
    removeBusy: "儲存庫正在進行索引。請稍後再嘗試移除。",
    removeFailed: "移除失敗：{detail}",
    docStatusPending: "待處理",
    docStatusProcessing: "索引中",
    docStatusIndexed: "已索引",
    docStatusFailed: "失敗",
    docStatusUnknown: "未知",
    docChunks: "{count} 個區塊",
    docSummary: "摘要",
    docNoSummary: "此儲存庫未提供此文件的預覽。",
  },
  enterprise: {
    title: "Enterprise",
    ...
    noRuns: "尚未記錄任何企業執行。",
    noTrees: "尚未註冊任何工作流程樹。",
    selectRun: "選擇一個執行以檢視其步驟與治理追蹤。",
    detailUnavailable: "執行詳情已不再可用。",
    detailTitle: "執行詳情",
    activeStep: "進行中的步驟：{node}",
    executionCount: "此執行共 {count} 次執行紀錄",
    stepsTitle: "步驟",
    traceTitle: "治理追蹤",
    noTrace: "此次執行未記錄任何治理事件。",
    allowedTools: "允許：{tools}",
    ...
    activeBadge: "進行中",
    nodeCount: "{count} 個步驟",
    importErrors: "部分匯入的樹狀結構載入失敗；已封鎖對其執行強制模式。",
    storeError: "工作流程樹狀結構儲存無法讀取：{message}",
    selectTree: "選取工作流程樹狀結構以視覺化其結構與本體。",
    treeTitle: "樹狀結構視覺化",
    ...
    nodeInspectorTitle: "節點本體論",
    nodeNoOntology: "此步驟的範圍未宣告任何本體論類型。",
    nodeObjectsTitle: "物件",
    nodeNoObjects: "此類型尚無任何物件。",
    addNodeButton: "新增子節點",
    addNodeTitle: "新增子節點",
    addNodeIdLabel: "節點 ID（小寫以點分隔，例如 support.triage）",
    addNodeTitleLabel: "標題",
    addNodeSubmit: "新增至編輯器",
    addNodeErrorIdEmpty: "請輸入節點 ID。",
    addNodeErrorIdPattern: "ID 必須為小寫以點分隔，例如 support.triage。",
    addNodeErrorIdDuplicate: "此樹狀結構中已存在具有該 ID 的節點。",
    addNodeErrorTitleEmpty: "請輸入標題。",
    addNodeErrorParentMissing: "父節點已不在此樹狀結構中。",
    addNodeErrorExportFailed: "無法載入要編輯的樹狀結構定義。",
    ...
    routeCoverage: "已規劃 {coverage} 個節點",
    routeInvalid: "規劃器命名了此樹中不存在的路由：{routes}",
    routeSource: {
      planner: "規劃器",
      wholeTree: "整棵樹",
    },
    resetView: "重設檢視",
    noRelationships: "無已宣告的關係。",
    selectStep: "選取一個步驟以檢視其本體範圍。",
    noStepScope: "此步驟未宣告本體範圍。",
    actions: "動作：{ids}",
    contextHints: "上下文提示：{hints}",
    expectedOutput: "預期輸出：{text}",
    newTree: "新增樹",
    edit: "編輯",
    exportYaml: "匯出 YAML",
    exportJson: "匯出 JSON",
    remove: "移除",
    editorTitle: "編輯樹定義",
    editorHint: "編輯原始定義，然後儲存以記錄新版本。",
    saveInvalid: "定義驗證未通過：",
    saving: "儲存中…",
    save: "儲存",
    historyTitle: "版本歷史",
    noHistory: "尚無已儲存的修訂版本。",
    revision: "修訂版本 {revision}",
    confirmSaveTitle: "儲存工作流程樹？",
    confirmSaveBody: "這將匯入已編輯的定義並記錄新的修訂版本。",
    confirmRemoveTitle: "移除工作流程樹？",
    confirmRemoveBody: "從登錄檔中移除已匯入的工作流程樹 {treeId}。",
    confirmRemoveWarning: "即時定義將被刪除；被覆蓋的內建定義將重新出現。版本歷史會保留。",
  },
  sessionsView: {
    title: "工作階段",
