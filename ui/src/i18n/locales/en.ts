...
export const en: TranslationMap = {
  ...
  knowledge: {
    ...
    files: "Files",
    filesShow: "Show files",
    filesHide: "Hide files",
    filesEmpty: "No documents have been uploaded yet.",
    filesReadOnly: "This foundation is operated elsewhere, so its documents are read-only here.",
    filesUnsupported: "This adapter does not expose document management.",
    filesNotRegistered: "This foundation is no longer registered. Refresh the list.",
    filesFailed: "Could not load documents.",
    upload: "Upload document",
    uploading: "Uploading…",
    uploadAccepted: "{name} uploaded. Indexing runs in the background.",
    uploadDuplicate: "A document named {name} already exists. Remove it before re-uploading.",
    uploadTooLarge: "That file is larger than the {limit} upload limit.",
    uploadFailed: "Upload failed: {detail}",
    remove: "Remove",
    removeTitle: "Remove {name}?",
    removeBody:
      "This deletes the document and everything indexed from it. Agents will no longer retrieve it. This cannot be undone.",
    removeStarted: "Removal of {name} started. It runs in the background.",
    removeBusy: "The store is busy indexing. Try removing again shortly.",
    removeFailed: "Removal failed: {detail}",
    docStatusPending: "Pending",
    docStatusProcessing: "Indexing",
    docStatusIndexed: "Indexed",
    docStatusFailed: "Failed",
    docStatusUnknown: "Unknown",
    docChunks: "{count} chunk(s)",
    docSummary: "Summary",
    docNoSummary: "This store exposes no preview for this document.",
  },
  enterprise: {
    title: "Enterprise",
    ...
    noTrees: "No workflow trees registered.",
    selectRun: "Select a run to inspect its steps and governance trace.",
    detailUnavailable: "Run detail is no longer available.",
    ...
    importErrors: "Some imported trees failed to load; enforce-mode runs on them are blocked.",
    storeError: "Workflow tree store unreadable: {message}",
    ...
    nodeInspectorTitle: "Node ontology",
    nodeNoOntology: "This step's scope declares no ontology types.",
    nodeObjectsTitle: "Objects",
    nodeNoObjects: "No objects of this type exist yet.",
    ...
    noStepScope: "This step declares no ontology scope.",
    actions: "Actions: {ids}",
    contextHints: "Context hints: {hints}",
    ...
    remove: "Remove",
    editorTitle: "Edit tree definition",
    editorHint: "Edit the raw definition, then Save to record a new version.",
    saveInvalid: "The definition did not validate:",
    saving: "Saving…",
    save: "Save",
    historyTitle: "Version history",
    noHistory: "No saved revisions yet.",
    revision: "Revision {revision}",
    confirmSaveTitle: "Save workflow tree?",
    confirmSaveBody: "This imports the edited definition and records a new revision.",
    confirmRemoveTitle: "Remove workflow tree?",
    confirmRemoveBody: "Remove the imported tree {treeId} from the registry.",
    confirmRemoveWarning:
      "The live definition is deleted; a shadowed built-in reappears. Version history is kept.",
  },
  sessionsView: {
    title: "Sessions",
