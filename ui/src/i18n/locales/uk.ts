...
export const uk: TranslationMap = {
  ...
  knowledge: {
    title: "Бази знань",
    subtitle: "Джерела пошуку, які може запитувати інструмент knowledge_search.",
    empty: "Жодної бази знань не зареєстровано.",
    emptyHint: "Увімкніть плагін-адаптер (наприклад, LightRAG), щоб зареєструвати базу.",
    kindLocal: "локальна",
    kindRemote: "віддалена",
    kindLocalTitle: "Цей розгортання керує документами цього сервера.",
    kindRemoteTitle: "Працює в іншому місці; тут доступна лише для читання.",
    testConnection: "Перевірити з'єднання",
    testing: "Перевірка…",
    statusOk: "Доступна",
    statusFailed: "Недоступна",
    statusUnsupported: "Неможливо перевірити",
    statusNotRegistered: "Більше не зареєстрована",
    statusUnsupportedTitle: "Цей адаптер не підтримує перевірку з'єднання.",
    statusNotRegisteredTitle: "Плагін, який її зареєстрував, більше не активний. Оновіть список.",
    referencedBy: "Використовується в {count} кроці(-ах)",
    referencedByNone: "Не використовується жодним кроком робочого процесу.",
    referencedByHint:
      "Кроки, чий список дозволених онтологій містить цю базу. Редагуйте список дозволених на вкладці Enterprise.",
    files: "Файли",
    filesShow: "Показати файли",
    filesHide: "Сховати файли",
    filesEmpty: "Документи ще не завантажено.",
    filesReadOnly:
      "Ця основа керується в іншому місці, тому її документи тут доступні лише для читання.",
    filesUnsupported: "Цей адаптер не підтримує керування документами.",
    filesNotRegistered: "Цю основу більше не зареєстровано. Оновіть список.",
    filesFailed: "Не вдалося завантажити документи.",
    upload: "Завантажити документ",
    uploading: "Завантаження…",
    uploadAccepted: "{name} завантажено. Індексація виконується у фоновому режимі.",
    uploadDuplicate:
      "Документ з назвою {name} вже існує. Видаліть його перед повторним завантаженням.",
    uploadTooLarge: "Цей файл перевищує ліміт завантаження {limit}.",
    uploadFailed: "Помилка завантаження: {detail}",
    remove: "Видалити",
    removeTitle: "Видалити {name}?",
    removeBody:
      "Це видалить документ і все, що з нього проіндексовано. Агенти більше не зможуть його отримати. Цю дію не можна скасувати.",
    removeStarted: "Видалення {name} розпочато. Воно виконується у фоновому режимі.",
    removeBusy: "Сховище зайняте індексацією. Спробуйте видалити пізніше.",
    removeFailed: "Помилка видалення: {detail}",
    docStatusPending: "Очікує",
    docStatusProcessing: "Індексація",
    docStatusIndexed: "Проіндексовано",
    docStatusFailed: "Помилка",
    docStatusUnknown: "Невідомо",
    docChunks: "{count} фрагмент(ів)",
    docSummary: "Резюме",
    docNoSummary: "Це сховище не надає попередній перегляд для цього документа.",
  },
  enterprise: {
    title: "Enterprise",
    ...
    noTrees: "Немає зареєстрованих дерев робочих процесів.",
    selectRun: "Виберіть запуск, щоб переглянути його кроки та трасування управління.",
    detailUnavailable: "Деталі запуску більше недоступні.",
    detailTitle: "Деталі запуску",
    activeStep: "Активний крок: {node}",
    executionCount: "{count} виконання цього запуску",
    stepsTitle: "Кроки",
    traceTitle: "Трасування управління",
    noTrace: "Для цього виконання не записано подій управління.",
    allowedTools: "Дозволити: {tools}",
    ...
    importErrors:
      "Деякі імпортовані дерева не вдалося завантажити; запуски в режимі enforce для них заблоковано.",
    storeError: "Сховище дерев робочих процесів недоступне для читання: {message}",
    selectTree: "Виберіть дерево робочого процесу, щоб візуалізувати його структуру та онтологію.",
    treeTitle: "Візуалізація дерева",
    ...
    nodeInspectorTitle: "Онтологія вузла",
    nodeNoOntology: "Область дії цього кроку не оголошує типів онтології.",
    nodeObjectsTitle: "Об'єкти",
    nodeNoObjects: "Об'єктів цього типу ще не існує.",
    addNodeButton: "Додати дочірній вузол",
    addNodeTitle: "Новий дочірній вузол",
    addNodeIdLabel: "Ідентифікатор вузла (малі літери через крапку, напр. support.triage)",
    addNodeTitleLabel: "Назва",
    addNodeSubmit: "Додати до редактора",
    addNodeErrorIdEmpty: "Введіть ідентифікатор вузла.",
    addNodeErrorIdPattern:
      "Ідентифікатор має бути малими літерами через крапку, напр. support.triage.",
    addNodeErrorIdDuplicate: "Вузол із таким ідентифікатором уже існує в цьому дереві.",
    addNodeErrorTitleEmpty: "Введіть назву.",
    addNodeErrorParentMissing: "Батьківський вузол більше не існує в цьому дереві.",
    addNodeErrorExportFailed: "Не вдалося завантажити визначення дерева для редагування.",
    ...
    mode: {
      label: "Enterprise",
      hint: "Керований режим робочого процесу для цього асистента",
      enforce: {
        label: "Enforce",
        hint: "Управління блокує інструменти поза межами дозволеного",
      },
      observe: {
        label: "Observe",
        hint: "Записує рішення, нічого не блокує",
      },
      off: {
        label: "Вимкнено",
        hint: "Без медіації робочого процесу",
      },
    },
    routeCoverage: "{coverage} вузлів заплановано",
    routeInvalid: "Планувальник назвав маршрути, яких не існує в цьому дереві: {routes}",
    routeSource: {
      planner: "планувальник",
      wholeTree: "усе дерево",
    },
    resetView: "Скинути вигляд",
    noRelationships: "Немає оголошених зв'язків.",
    selectStep: "Виберіть крок, щоб переглянути його онтологічну область.",
    noStepScope: "Цей крок не оголошує онтологічної області.",
    actions: "Дії: {ids}",
    contextHints: "Підказки контексту: {hints}",
    expectedOutput: "Очікуваний результат: {text}",
    newTree: "Нове дерево",
    edit: "Редагувати",
    exportYaml: "Експортувати YAML",
    exportJson: "Експортувати JSON",
    remove: "Видалити",
    editorTitle: "Редагувати визначення дерева",
    editorHint:
      "Відредагуйте необроблене визначення, потім натисніть «Зберегти», щоб записати нову версію.",
    saveInvalid: "Визначення не пройшло валідацію:",
    saving: "Збереження…",
    save: "Зберегти",
    historyTitle: "Історія версій",
    noHistory: "Збережених ревізій поки немає.",
    revision: "Ревізія {revision}",
    confirmSaveTitle: "Зберегти дерево робочого процесу?",
    confirmSaveBody: "Це імпортує відредаговане визначення та створить нову ревізію.",
    confirmRemoveTitle: "Видалити дерево робочого процесу?",
    confirmRemoveBody: "Видалити імпортоване дерево {treeId} з реєстру.",
    confirmRemoveWarning:
      "Активне визначення буде видалено; вбудоване визначення з'явиться знову. Історія версій зберігається.",
  },
  sessionsView: {
    title: "Сеанси",
  ...
  subtitles: {
    ...
    enterprise: "Дерева робочих процесів і керовані запуски.",
    knowledge: "Зареєстровані бази знань та їхній статус.",
  },
  skillWorkshop: {
    header: {
