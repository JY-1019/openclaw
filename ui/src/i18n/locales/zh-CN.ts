...
export const zh_CN: TranslationMap = {
  ...
  knowledge: {
    ...
    kindRemoteTitle: "由其他位置运营；此处为只读。",
    testConnection: "测试连接",
    testing: "测试中…",
    statusOk: "可达",
    statusFailed: "不可达",
    statusUnsupported: "无法检测",
    statusNotRegistered: "已取消注册",
    statusUnsupportedTitle: "此适配器未实现连接检测。",
    statusNotRegisteredTitle: "注册该知识基础的插件已不再活跃。请刷新列表。",
    referencedBy: "被 {count} 个步骤引用",
    referencedByNone: "未被任何工作流步骤引用。",
    referencedByHint: "本体允许列表中包含此基础名称的步骤。可在 Enterprise 选项卡中编辑允许列表。",
    files: "文件",
    filesShow: "显示文件",
    filesHide: "隐藏文件",
    filesEmpty: "尚未上传任何文档。",
    filesReadOnly: "此基础由其他位置管理，因此其文档在此处为只读。",
    filesUnsupported: "此适配器不支持文档管理。",
    filesNotRegistered: "此基础已不再注册。请刷新列表。",
    filesFailed: "无法加载文档。",
    upload: "上传文档",
    uploading: "上传中…",
    uploadAccepted: "{name} 已上传。索引正在后台运行。",
    uploadDuplicate: "已存在名为 {name} 的文档。请先删除后再重新上传。",
    uploadTooLarge: "该文件超过了 {limit} 的上传限制。",
    uploadFailed: "上传失败：{detail}",
    remove: "移除",
    removeTitle: "删除 {name}？",
    removeBody: "此操作将删除该文档及其所有索引内容。代理将无法再检索到它。此操作无法撤销。",
    removeStarted: "{name} 的删除已开始，正在后台运行。",
    removeBusy: "存储正在索引中，请稍后再尝试删除。",
    removeFailed: "删除失败：{detail}",
    docStatusPending: "待处理",
  ...
  enterprise: {
    ...
    noTrees: "尚无已注册的工作流树。",
    selectRun: "选择一次运行以查看其步骤和治理追踪。",
    detailUnavailable: "运行详情已不可用。",
    detailTitle: "运行详情",
    ...
    activeBadge: "活跃",
    nodeCount: "{count} 个步骤",
    importErrors: "部分导入的树加载失败；已阻止对其执行强制模式运行。",
    storeError: "工作流树存储不可读：{message}",
    ...
    nodeInspectorTitle: "节点本体",
    nodeNoOntology: "此步骤的范围未声明任何本体类型。",
    nodeObjectsTitle: "对象",
    nodeNoObjects: "此类型尚无对象。",
    addNodeButton: "添加子节点",
    addNodeTitle: "新建子节点",
    addNodeIdLabel: "节点 ID（小写点分格式，例如 support.triage）",
    addNodeTitleLabel: "标题",
    addNodeSubmit: "添加到编辑器",
    addNodeErrorIdEmpty: "请输入节点 ID。",
    addNodeErrorIdPattern: "ID 必须为小写点分格式，例如 support.triage。",
    addNodeErrorIdDuplicate: "此树中已存在具有该 ID 的节点。",
    addNodeErrorTitleEmpty: "请输入标题。",
    addNodeErrorParentMissing: "父节点已不在此树中。",
    addNodeErrorExportFailed: "无法加载要编辑的树定义。",
    graphHint: "拖动节点 · 滚动缩放",
    routeTitle: "已采用的路径",
    routeViewLabel: "路由视图",
    routeViewRoute: "仅路由",
    ...
    routeCoverage: "已规划 {coverage} 个节点",
    routeInvalid: "规划器命名的路由在此树中不存在：{routes}",
    routeSource: {
      planner: "规划器",
      wholeTree: "整棵树",
    },
    resetView: "重置视图",
    noRelationships: "无已声明的关系。",
    selectStep: "选择一个步骤以查看其本体范围。",
    noStepScope: "此步骤未声明本体范围。",
    actions: "操作：{ids}",
    contextHints: "上下文提示：{hints}",
    expectedOutput: "预期输出：{text}",
    newTree: "新建树",
    edit: "编辑",
    exportYaml: "导出 YAML",
    exportJson: "导出 JSON",
    remove: "移除",
    editorTitle: "编辑树定义",
    editorHint: "编辑原始定义，然后点击保存以记录新版本。",
    saveInvalid: "定义验证未通过：",
    saving: "保存中…",
    save: "保存",
    historyTitle: "版本历史",
    noHistory: "暂无已保存的修订版本。",
    revision: "修订版本 {revision}",
    confirmSaveTitle: "保存工作流树？",
    confirmSaveBody: "这将导入编辑后的定义并记录一个新的修订版本。",
    confirmRemoveTitle: "移除工作流树？",
    confirmRemoveBody: "从注册表中移除已导入的工作流树 {treeId}。",
    confirmRemoveWarning: "当前定义将被删除；被覆盖的内置定义将重新生效。版本历史将保留。",
  },
  sessionsView: {
    title: "会话",
