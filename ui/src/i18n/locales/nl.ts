...
export const nl: TranslationMap = {
  ...
  knowledge: {
    title: "Kennisfundamenten",
    subtitle: "Bronnen die de knowledge_search tool kan doorzoeken.",
    empty: "Er zijn geen kennisfundamenten geregistreerd.",
    emptyHint: "Schakel een adapterplugin in (bijvoorbeeld LightRAG) om er een te registreren.",
    kindLocal: "lokaal",
    kindRemote: "extern",
    kindLocalTitle: "Deze implementatie beheert de documenten van deze server.",
    kindRemoteTitle: "Elders beheerd; vanaf hier alleen-lezen.",
    testConnection: "Verbinding testen",
    testing: "Testen…",
    statusOk: "Bereikbaar",
    statusFailed: "Onbereikbaar",
    statusUnsupported: "Niet controleerbaar",
    statusNotRegistered: "Niet meer geregistreerd",
    statusUnsupportedTitle: "Deze adapter ondersteunt geen verbindingscontrole.",
    statusNotRegisteredTitle:
      "De plugin die dit heeft geregistreerd is niet meer actief. Vernieuw de lijst.",
    referencedBy: "Gebruikt door {count} stap(pen)",
    referencedByNone: "Niet gebruikt door een workflowstap.",
    referencedByHint:
      "Stappen waarvan de ontologie-allowlist dit fundament bevat. Bewerk de allowlist in het Enterprise-tabblad.",
    files: "Bestanden",
    filesShow: "Bestanden tonen",
    filesHide: "Bestanden verbergen",
    filesEmpty: "Er zijn nog geen documenten geüpload.",
    filesReadOnly:
      "Deze foundation wordt elders beheerd, dus de documenten zijn hier alleen-lezen.",
    filesUnsupported: "Deze adapter biedt geen documentbeheer.",
    filesNotRegistered: "Deze foundation is niet meer geregistreerd. Vernieuw de lijst.",
    filesFailed: "Kan documenten niet laden.",
    upload: "Document uploaden",
    uploading: "Uploaden…",
    uploadAccepted: "{name} geüpload. Indexering wordt op de achtergrond uitgevoerd.",
    uploadDuplicate:
      "Er bestaat al een document met de naam {name}. Verwijder het voordat je opnieuw uploadt.",
    uploadTooLarge: "Dat bestand is groter dan de uploadlimiet van {limit}.",
    uploadFailed: "Upload mislukt: {detail}",
    remove: "Verwijderen",
    removeTitle: "{name} verwijderen?",
    removeBody:
      "Hiermee worden het document en alles wat eruit geïndexeerd is verwijderd. Agents kunnen het niet meer ophalen. Dit kan niet ongedaan worden gemaakt.",
    removeStarted: "Verwijdering van {name} gestart. Dit wordt op de achtergrond uitgevoerd.",
    removeBusy: "De opslag is bezig met indexeren. Probeer het verwijderen zo opnieuw.",
    removeFailed: "Verwijdering mislukt: {detail}",
    docStatusPending: "In afwachting",
    docStatusProcessing: "Indexeren",
    docStatusIndexed: "Geïndexeerd",
    docStatusFailed: "Mislukt",
    docStatusUnknown: "Onbekend",
    docChunks: "{count} chunk(s)",
    docSummary: "Samenvatting",
    docNoSummary: "Deze opslag toont geen voorbeeld voor dit document.",
  },
  enterprise: {
    title: "Enterprise",
    ...
    noTrees: "Geen workflowbomen geregistreerd.",
    selectRun: "Selecteer een uitvoering om de stappen en governancetrace te inspecteren.",
    detailUnavailable: "Uitvoeringsdetail is niet meer beschikbaar.",
    detailTitle: "Uitvoeringsdetail",
    activeStep: "Actieve stap: {node}",
    executionCount: "{count} uitvoering(en) van deze run",
    stepsTitle: "Stappen",
    traceTitle: "Governancetrace",
    noTrace: "Geen governancegebeurtenissen geregistreerd voor deze uitvoering.",
    ...
    importErrors:
      "Sommige geïmporteerde bomen konden niet worden geladen; enforce-modus wordt hiervoor geblokkeerd.",
    storeError: "Werkstroomboom-opslag onleesbaar: {message}",
    ...
    nodeInspectorTitle: "Node-ontologie",
    nodeNoOntology: "Het bereik van deze stap declareert geen ontologietypen.",
    nodeObjectsTitle: "Objecten",
    nodeNoObjects: "Er bestaan nog geen objecten van dit type.",
    addNodeButton: "Onderliggend knooppunt toevoegen",
    addNodeTitle: "Nieuw onderliggend knooppunt",
    addNodeIdLabel: "Knooppunt-id (kleine letters met punten, bijv. support.triage)",
    addNodeTitleLabel: "Titel",
    addNodeSubmit: "Toevoegen aan editor",
    addNodeErrorIdEmpty: "Voer een knooppunt-id in.",
    addNodeErrorIdPattern: "Id moet kleine letters met punten zijn, bijv. support.triage.",
    addNodeErrorIdDuplicate: "Een knooppunt met dat id bestaat al in deze boom.",
    addNodeErrorTitleEmpty: "Voer een titel in.",
    addNodeErrorParentMissing: "Het bovenliggende knooppunt bevindt zich niet meer in deze boom.",
    addNodeErrorExportFailed: "Kan de boomdefinitie niet laden om te bewerken.",
    ...
    mode: {
      label: "Enterprise",
      hint: "Beheerde werkstroommodus voor deze assistent",
      enforce: {
        label: "Enforce",
        hint: "Governance blokkeert tools buiten scope",
      },
      observe: {
        label: "Observe",
        hint: "Registreert beslissingen, blokkeert niets",
      },
      off: {
        label: "Uit",
        hint: "Geen workflow-bemiddeling",
      },
    },
    routeCoverage: "{coverage} nodes gepland",
    routeInvalid: "De planner heeft routes benoemd die niet bestaan in deze boom: {routes}",
    routeSource: {
      planner: "planner",
      wholeTree: "volledige boom",
    },
    resetView: "Weergave resetten",
    noRelationships: "Geen gedeclareerde relaties.",
    selectStep: "Selecteer een stap om het ontologiebereik te inspecteren.",
    noStepScope: "Deze stap declareert geen ontologiebereik.",
    actions: "Acties: {ids}",
    contextHints: "Contexthints: {hints}",
    expectedOutput: "Verwachte output: {text}",
    newTree: "Nieuwe boom",
    edit: "Bewerken",
    exportYaml: "YAML exporteren",
    exportJson: "JSON exporteren",
    remove: "Verwijderen",
    editorTitle: "Boomdefinitie bewerken",
    editorHint: "Bewerk de ruwe definitie en klik op Opslaan om een nieuwe versie vast te leggen.",
    saveInvalid: "De definitie kon niet worden gevalideerd:",
    saving: "Opslaan…",
    save: "Opslaan",
    historyTitle: "Versiegeschiedenis",
    noHistory: "Nog geen opgeslagen revisies.",
    revision: "Revisie {revision}",
    confirmSaveTitle: "Workflowstructuur opslaan?",
    confirmSaveBody: "Dit importeert de bewerkte definitie en registreert een nieuwe revisie.",
    confirmRemoveTitle: "Workflowstructuur verwijderen?",
    confirmRemoveBody: "Verwijder de geïmporteerde structuur {treeId} uit het register.",
    confirmRemoveWarning:
      "De actieve definitie wordt verwijderd; een onderliggende ingebouwde definitie verschijnt weer. Versiegeschiedenis blijft behouden.",
  },
  sessionsView: {
    title: "Sessies",
