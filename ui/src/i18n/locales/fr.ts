...
export const fr: TranslationMap = {
  ...
  knowledge: {
    ...
    subtitle: "Sources de récupération que l'outil knowledge_search peut interroger.",
    empty: "Aucune base de connaissances n'est enregistrée.",
    emptyHint: "Activez un plugin adaptateur (par exemple LightRAG) pour en enregistrer une.",
    kindLocal: "local",
    kindRemote: "distant",
    kindLocalTitle: "Ce déploiement administre les documents de ce serveur.",
    kindRemoteTitle: "Exploité ailleurs ; en lecture seule depuis ici.",
    testConnection: "Tester la connexion",
    testing: "Test en cours…",
    statusOk: "Accessible",
    statusFailed: "Inaccessible",
    statusUnsupported: "Non vérifiable",
    statusNotRegistered: "Plus enregistré",
    statusUnsupportedTitle: "Cet adaptateur n'implémente pas de vérification de connexion.",
    statusNotRegisteredTitle: "Le plugin qui l'a enregistré n'est plus actif. Actualisez la liste.",
    referencedBy: "Référencé par {count} étape(s)",
    referencedByNone: "Non référencé par aucune étape de workflow.",
    referencedByHint:
      "Étapes dont la liste autorisée de l'ontologie nomme cette base. Modifiez la liste autorisée dans l'onglet Enterprise.",
    files: "Fichiers",
    filesShow: "Afficher les fichiers",
    filesHide: "Masquer les fichiers",
    filesEmpty: "Aucun document n'a encore été téléversé.",
    filesReadOnly: "Cette fondation est gérée ailleurs, ses documents sont en lecture seule ici.",
    filesUnsupported: "Cet adaptateur ne propose pas la gestion des documents.",
    filesNotRegistered: "Cette fondation n'est plus enregistrée. Actualisez la liste.",
    filesFailed: "Impossible de charger les documents.",
    upload: "Téléverser un document",
    uploading: "Téléversement…",
    uploadAccepted: "{name} téléversé. L'indexation s'exécute en arrière-plan.",
    uploadDuplicate:
      "Un document nommé {name} existe déjà. Supprimez-le avant de le téléverser à nouveau.",
    uploadTooLarge: "Ce fichier dépasse la limite de téléversement de {limit}.",
    uploadFailed: "Échec du téléversement : {detail}",
    remove: "Supprimer",
    removeTitle: "Supprimer {name} ?",
    removeBody:
      "Cette action supprime le document et tout ce qui en a été indexé. Les agents ne pourront plus le récupérer. Cette action est irréversible.",
    removeStarted: "La suppression de {name} a commencé. Elle s'exécute en arrière-plan.",
    removeBusy: "Le magasin est en cours d'indexation. Réessayez sous peu.",
    removeFailed: "Échec de la suppression : {detail}",
    docStatusPending: "En attente",
    docStatusProcessing: "Indexation",
    docStatusIndexed: "Indexé",
    docStatusFailed: "Échoué",
    docStatusUnknown: "Inconnu",
    docChunks: "{count} fragment(s)",
    docSummary: "Résumé",
    docNoSummary: "Ce store n'expose aucun aperçu pour ce document.",
  },
  enterprise: {
    title: "Enterprise",
    ...
    noTrees: "Aucune arborescence de workflow enregistrée.",
    selectRun: "Sélectionnez une exécution pour inspecter ses étapes et sa trace de gouvernance.",
    detailUnavailable: "Le détail de l'exécution n'est plus disponible.",
    detailTitle: "Détail de l'exécution",
    activeStep: "Étape active : {node}",
    executionCount: "{count} exécution(s) de cette session",
    stepsTitle: "Étapes",
    traceTitle: "Trace de gouvernance",
    noTrace: "Aucun événement de gouvernance enregistré pour cette exécution.",
    allowedTools: "Autoriser : {tools}",
    deniedTools: "Refuser : {tools}",
    knowledge: "Connaissances : {ids}",
    guidance: "Instructions : {text}",
    audit: "Audité",
    activeBadge: "actif",
    nodeCount: "{count} étape(s)",
    importErrors:
      "Certains arbres importés n'ont pas pu être chargés ; les exécutions en mode enforce sont bloquées.",
    storeError: "Le magasin d'arbres de workflow est illisible : {message}",
    selectTree: "Sélectionnez un arbre de workflow pour visualiser sa structure et son ontologie.",
    treeTitle: "Visualisation de l'arbre",
    treeUnavailable: "La définition de l'arbre n'est plus disponible.",
    structureTitle: "Structure",
    ontologyTitle: "Ontologie",
    wholeTreeOverviewTitle: "Vue d'ensemble de l'arborescence",
    action: "Action : {id}",
    constraint: "Contrainte : {text}",
    noOntology: "Cet arbre ne déclare aucune entité ni relation d'ontologie.",
    nodeInspectorTitle: "Ontologie du nœud",
    nodeNoOntology: "La portée de cette étape ne déclare aucun type d'ontologie.",
    nodeObjectsTitle: "Objets",
    nodeNoObjects: "Aucun objet de ce type n'existe encore.",
    addNodeButton: "Ajouter un nœud enfant",
    addNodeTitle: "Nouveau nœud enfant",
    addNodeIdLabel: "Id du nœud (minuscules avec points, ex. support.triage)",
    addNodeTitleLabel: "Titre",
    addNodeSubmit: "Ajouter à l'éditeur",
    addNodeErrorIdEmpty: "Saisissez un id de nœud.",
    addNodeErrorIdPattern: "L'id doit être en minuscules avec points, ex. support.triage.",
    addNodeErrorIdDuplicate: "Un nœud avec cet id existe déjà dans cet arbre.",
    addNodeErrorTitleEmpty: "Saisissez un titre.",
    addNodeErrorParentMissing: "Le nœud parent ne se trouve plus dans cet arbre.",
    addNodeErrorExportFailed: "Impossible de charger la définition de l'arbre à modifier.",
    ...
    routeExpand: "Développer",
    routeExpandTitle: "Route du workflow",
    routeExpandClose: "Fermer",
    propertyPrimaryKey: "PK",
    propertyRequired: "requis",
    mode: {
      label: "Enterprise",
      hint: "Mode de workflow gouverné pour cet assistant",
      enforce: {
        label: "Enforce",
        hint: "La gouvernance bloque les outils hors périmètre",
      },
      observe: {
        label: "Observe",
        hint: "Enregistre les décisions, ne bloque rien",
      },
      off: {
        label: "Désactivée",
        hint: "Aucune médiation de workflow",
      },
    },
    routeCoverage: "{coverage} nœuds planifiés",
    routeInvalid:
      "Le planificateur a nommé des routes qui n'existent pas dans cet arbre : {routes}",
    routeSource: {
      planner: "planificateur",
      wholeTree: "arbre entier",
    },
    resetView: "Réinitialiser la vue",
    noRelationships: "Aucune relation déclarée.",
    selectStep: "Sélectionnez une étape pour inspecter sa portée ontologique.",
    noStepScope: "Cette étape ne déclare aucune portée ontologique.",
    actions: "Actions : {ids}",
    contextHints: "Indices de contexte : {hints}",
    expectedOutput: "Sortie attendue : {text}",
    newTree: "Nouvel arbre",
    edit: "Modifier",
    exportYaml: "Exporter en YAML",
    exportJson: "Exporter en JSON",
    remove: "Supprimer",
    editorTitle: "Modifier la définition de l'arbre",
    editorHint: "Modifiez la définition brute, puis enregistrez pour créer une nouvelle version.",
    saveInvalid: "La définition n'a pas été validée :",
    saving: "Enregistrement…",
    save: "Enregistrer",
    historyTitle: "Historique des versions",
    noHistory: "Aucune révision enregistrée pour le moment.",
    revision: "Révision {revision}",
    confirmSaveTitle: "Enregistrer l'arbre de workflow ?",
    confirmSaveBody: "Cela importe la définition modifiée et enregistre une nouvelle révision.",
    confirmRemoveTitle: "Supprimer l'arbre de workflow ?",
    confirmRemoveBody: "Supprimer l'arbre importé {treeId} du registre.",
    confirmRemoveWarning:
      "La définition active est supprimée ; une définition intégrée masquée réapparaît. L'historique des versions est conservé.",
  },
  sessionsView: {
    title: "Sessions",
