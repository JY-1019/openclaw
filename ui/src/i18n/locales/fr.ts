...
export const fr: TranslationMap = {
  ...
  enterprise: {
    ...
    addNodeButton: "Add child node",
    addNodeTitle: "New child node",
    addNodeIdLabel: "Node id (dotted lowercase, e.g. support.triage)",
    addNodeTitleLabel: "Title",
    addNodeSubmit: "Add to editor",
    addNodeErrorIdEmpty: "Enter a node id.",
    addNodeErrorIdPattern: "Id must be dotted lowercase, e.g. support.triage.",
    addNodeErrorIdDuplicate: "A node with that id already exists in this tree.",
    addNodeErrorTitleEmpty: "Enter a title.",
    addNodeErrorParentMissing: "The parent node is no longer in this tree.",
    addNodeErrorExportFailed: "Could not load the tree definition to edit.",
